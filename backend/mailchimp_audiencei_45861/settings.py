"""
Django settings for mailchimp_audiencei_45861 project.
...
ROOT_URLCONF = 'mailchimp_audiencei_45861.urls'
...
WSGI_APPLICATION = 'mailchimp_audiencei_45861.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mailchimp_audiencei_45861 API",
    "DESCRIPTION": "API documentation for mailchimp_audiencei_45861 App",
    "VERSION": "v1",
}
